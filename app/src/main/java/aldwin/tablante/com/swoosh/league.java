...
float i = (float) .7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leagueselection);
        TextView last = (TextView) findViewById(R.id.last);
        TextView last1 = (TextView) findViewById(R.id.last1);
        next = (Button) findViewById(R.id.leaguebtn4);
        M = (Button) findViewById(R.id.leaguebtn1);

        N = (Button) findViewById(R.id.leaguebtn2);
        C = (Button) findViewById(R.id.leaguebtn3);
        ...
        next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(num == 1){
                    ...
                    Intent intent = new Intent(getBaseContext(), skill.class);
